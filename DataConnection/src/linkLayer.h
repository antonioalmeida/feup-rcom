...
typedef enum { UA_START, UA_FLAG_RCV, UA_A_RCV, UA_C_RCV, UA_BCC_OK, UA_STOP } uaReceivedState;
...
int receiveUAStateMachine(char test, uaReceivedState* CURRENT_STATE);
